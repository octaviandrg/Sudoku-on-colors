...
public class GameGUI7x7 extends JFrame {
    private static final GameGUI7x7 gameGUI7x7 = new GameGUI7x7();
    ...
    private JTextArea textArea39;
    private JTextArea textArea47;
    private JTextArea textArea55;
    private JTextArea textArea46;
    private JTextArea textArea54;
    private JTextArea textArea45;
    private JTextArea textArea53;
    ...
    private JTextArea textArea50;
    private JTextArea textArea41;
    private JTextArea textArea49;
    ...
    public JCheckBox PURPLEcheckBox;
    ...
    public static GameGUI7x7 getInstance(String user, int score) {
        gameGUI7x7.setScoreLabel(score);
        gameGUI7x7.setUserLabel(user);
        return gameGUI7x7;
    }
    ...
    public void setTextArea6Color(Color color) {
        this.textArea6.setBackground(color);
    }
    ...
    public void setTextArea22Color(Color color) {
        this.textArea22.setBackground(color);
    }
    ...
    public void setTextArea15Color(Color color) {
        this.textArea15.setBackground(color);
    }

    public void setTextArea23Color(Color color) {
        this.textArea23.setBackground(color);
    }

    public void setTextArea31Color(Color color) {
        this.textArea31.setBackground(color);
    }

    public void setTextArea7Color(Color color) {
        this.textArea7.setBackground(color);
    }
    ...
    public void setTextArea39Color(Color color) {
        this.textArea39.setBackground(color);
    }

    public void setTextArea47Color(Color color) {
        this.textArea47.setBackground(color);
    }

    public void setTextArea55Color(Color color) {
        this.textArea55.setBackground(color);
    }
    ...
    public void setTextArea54Color(Color color) {
        this.textArea54.setBackground(color);
    }
    ...
    public void setTextArea53Color(Color color) {
        this.textArea53.setBackground(color);
    }
    ...
    public void setTextArea52Color(Color color) {
        this.textArea52.setBackground(color);
    }
    ...
    public void setTextArea51Color(Color color) {
        this.textArea51.setBackground(color);
    }
    ...
    public void setTextArea50Color(Color color) {
        this.textArea50.setBackground(color);
    }
    ...
    public void setTextArea49Color(Color color) {
        this.textArea49.setBackground(color);
    }
